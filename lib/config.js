...
export function loadConfig(env = process.env) {
  return {
    ...
    hf: {
      ...
      // Toolforge reaches the general internet through a web proxy; Wikimedia
      // endpoints are reachable directly. Typically set to
      // http://webproxy.eqiad.wmnet:8080 for this upstream only.
